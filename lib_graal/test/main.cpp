...
bool INT_bigg_than(  void *c )
{ 
	 int *c_c = static_cast<  int * >(c);
    return *c_c > 1;
};

/* Equality function for int */
bool INT_equal_to(  void *a,  void *b )
{ 
...
bool INT_sort_comp(  void *a,  void *b ){
     int * m_a = static_cast<  int * >(a);
     int * m_b = static_cast<  int * >(b);
...
TEST(IntRange, MinBasic)
{
    ...
    auto result = ( int *) graal::min( std::begin(A), std::end(A), sizeof(int),
            []( void *a,  void *b )
            {
...
bool CHAR_bigg_than(  void *c ){ 
	 char *c_c = static_cast<  char * >(c);
    return *c_c > 'a';
};

/* Equality function for char */
bool CHAR_equal_to(  void *a,  void *b )
{ 
	 char *a_ = static_cast<  char * >(a);
	 char *b_ = static_cast<  char * >(b);

    return *a_ == *b_;
};

/* Boolean sort for char */
bool CHAR_sort_comp(  void *a,  void *b ){
     char * m_a = static_cast<  char * >(a);
     char * m_b = static_cast<  char * >(b);
...
TEST(CharRange, MinBasic)
{
    ...
    auto result = ( char *) graal::min( std::begin(A), std::end(A), sizeof(char),
            []( void *a,  void *b )
            {
...
bool STR_bigg_than(  void *c ){ 
	 std::string *c_c = static_cast<  std::string * >(c);
    return *c_c > "aa";
};

/* Equality function for string */
bool STR_equal_to(  void *a,  void *b )
{ 
	 std::string *a_ = static_cast<  std::string * >(a);
	 std::string *b_ = static_cast<  std::string * >(b);

    return *a_ == *b_;
};

/* Boolean sort for std::string */
bool STR_sort_comp(  void *a,  void *b ){
     std::string * m_a = static_cast<  std::string * >(a);
     std::string * m_b = static_cast<  std::string * >(b);
...
TEST(StringRange, MinBasic)
{
    ...
    auto result = ( std::string *) graal::min( std::begin(A), std::end(A), sizeof(std::string),
            []( void *a,  void *b )
            {
